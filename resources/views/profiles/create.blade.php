@extends('layouts.app', ['activePage' => 'profiles-management', 'titlePage' => __(' - Create Profile')])
...
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <form method="post" action="{{ route('profiles.store') }}" autocomplete="off" class="form-horizontal">
                    @csrf
                    <div class="card ">
