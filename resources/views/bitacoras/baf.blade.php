@extends('layouts.app', ['activePage' => 'bitácora', 'titlePage' => __(' - Home')])
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="row">
                                        <label class="col-sm-3 col-form-label"
                                            for="anillamador">{{ __('Anillamador') }}</label>
                                        <div class="col-sm-9">
                                            <div
                                                class="form-group{{ $errors->has('anillamador') ? ' has-danger' : '' }}">
                                                <input
                                                    class="form-control{{ $errors->has('anillamador') ? ' is-invalid' : '' }}"
                                                    name="anillamador" id="input-anillamador" type="text"
                                                    placeholder="{{ __('Anillamador') }}"
                                                    value="{{ old('anillamador') }}" required="true"
                                                    aria-required="true" />
                                ...
                                <div class="col-lg-6">
                                    <div class="row">
                                        <label class="col-sm-3 col-form-label"
                                            for="dni">{{ __('Cédula / Pasaporte') }}</label>
                                        <div class="col-sm-9">
                                            <div class="form-group{{ $errors->has('dni') ? ' has-danger' : '' }}">
                                                <input
                                                    ...
                                                    placeholder="{{ __('Cédula ó pasaporte') }}"
                                                    value="{{ old('dni') }}" required="true" aria-required="true" />
                                                @if ($errors->has('dni'))
                                        ...
                                        <div class="col-sm-9">
                                            <div class="form-group{{ $errors->has('ticket') ? ' has-danger' : '' }}">
                                                <input
                                                    ...
                                                    name="ticket" id="input-ticket" type="text"
                                                    placeholder="{{ __('Ticket') }}" value="{{ old('ticket') }}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="form-group{{ $errors->has('tmo') ? ' has-danger' : '' }}">
                                                <input
                                                    class="form-control{{ $errors->has('tmo') ? ' is-invalid' : '' }}"
                                                    name="tmo" id="input-tmo" type="text"
                                                    placeholder="{{ __('Duración (00:00)') }}" value="{{ old('tmo') }}"
                                                    required="true" aria-required="true" />
                                                @if ($errors->has('tmo'))
                                                <span id="tmo-error" class="error text-danger"
                                                    for="input-tmo">{{ $errors->first('tmo') }}</span>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="form-group{{ $errors->has('coment') ? ' has-danger' : '' }}">
                                                <textarea
                                                    class="form-control{{ $errors->has('coment') ? ' is-invalid' : '' }}"
                                                    name="coment" id="input-coment" type="text"
                                                    placeholder="{{ __('Comentario') }}" value="{{ old('coment') }}"
