...
class BitacoraController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        //return strtolower(auth()->user()->group);
        ...
        return redirect()->route('bitacora.index')->withStatus(__("El ticket $key ha sido guardado correctamente."));
    }
